...
function doFormstuffOnLoad() {
	...
	console.log('Add validator icon');

	$('input[type!=submit], textarea, select').each(function() {
		...
		if(!$(this).hasClass('novalidate')) {
			...
			$(this).after('<div class="validatoricon"></div>');
		}
	});
